...
Revision ID: 930522575f1f
Revises: e9c914a89ea7
Create Date: 2019-04-18 17:26:20.766509
...
revision = '930522575f1f'
down_revision = 'e9c914a89ea7'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.UniqueConstraint('email', name='user_post_email_key'),
    sa.UniqueConstraint('username', name='user_post_username_key')
    )
